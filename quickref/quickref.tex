...
{\small \textbf{Try[T]} is (also) like a one element collection. \textbf{Try[T]} is either \textbf{Success[T]} (value present) or \textbf{Failure[E]} (where E is an exception). }
